            ...
            <div class="br-section-wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="">
                                <a href="{{route('agent.users.create')}}" class="btn btn-info">Add new user d</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="admin-action">
                                                        <div class="edit">
                                                            <a href="{{route('agent.users.show', $user->id)}}">Details</a>
                                                        </div>
                                                        <div class="edit">
                                                            {{--                                                            <a href="{{route('admin.post.edit', $post->id)}}">Edit</a>--}}
                                                        </div>
                                                        <div class="delete">
                                                            {!! Form::open(['method' => 'DELETE', 'action' => ['AgentUserController@destroy', $user->id]]) !!}
