                    ...
                    <div class="row">
                        <div class="col-5">
                            <div class="table-wrapper">
                                ...
                                {!! Form::open(['method' => 'POST', 'action' => 'AgentPostImageController@store', 'enctype' => 'multipart/form-data']) !!}
                                        ...
                                        @foreach($postImages as $postImage)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="delete">
                                                        {!! Form::open(['method' => 'DELETE', 'action' => ['AgentPostImageController@destroy', $postImage->id]]) !!}
